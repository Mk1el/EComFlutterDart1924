...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const  TextStyle().copyWith(fontSize:2.0, fontWeight: FontWeight.bold, color: Colors.black),
    ...
    labelMedium: const TextStyle().copyWith(fontSize:22.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
  );
  static TextTheme darkTextTheme = TextTheme(
    headlineLarge: const  TextStyle().copyWith(fontSize:2.0, fontWeight: FontWeight.bold, color: Colors.white),
    ...
    labelMedium: const TextStyle().copyWith(fontSize:22.0, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
  );
}